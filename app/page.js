...
with a secure modern marketplace experience.
...
<Link
href="/products"
className="rounded-xl bg-black px-8 py-4 font-bold text-white hover:bg-gray-800"
>
Browse Products
</Link>
...
className="rounded-xl bg-indigo-600 px-8 py-4 font-bold text-white hover:bg-indigo-700"
>
...
Create your seller account, upload products,
...
className="mt-8 inline-block rounded-xl bg-indigo-600 px-8 py-4 font-bold hover:bg-indigo-700"
